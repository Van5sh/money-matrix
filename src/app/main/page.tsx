...
export default function Page() {
  ...
  return (
    <div
      className="h-screen flex justify-center items-center bg-cover bg-center text-white backdrop-blur-md"
      style={{ backgroundImage: "url('/image.png')" }}
    >
      <div className="bg-black bg-opacity-80 p-8 rounded-2xl w-4/5 max-w-3xl flex shadow-lg">
